...
#ifdef DEBUG
	printk(KERN_INFO "f_vm : %d %d %d %d %d\n", f_vm[0], f_vm[1], f_vm[2], f_vm[3], f_vm[4]);
	printk(KERN_INFO "tmp_value : %ld %ld %ld %ld %ld\n", tmp_value[0], tmp_value[1], tmp_value[2], tmp_value[3], tmp_value[4]);
